...
public class UpdateGhostMap extends AsyncTask<ArrayList<Ghost>, ArrayList<Ghost>, ArrayList<Ghost>> {

	public AsyncData dataPasser = null;
	private int ghostAttack = 0, difficulty = 0, playerHealth = 13, size = 0;
	...
	protected ArrayList<Ghost> doInBackground(ArrayList<Ghost>... params) {
		while(isDead == false && !this.isCancelled()) {
			...
			if(ghostAttack >= this.getPlayerHealth() - difficulty*2)
				isDead = true;
